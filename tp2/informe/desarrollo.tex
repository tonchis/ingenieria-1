...
\begin{tabular}{ | p{14cm} | }
  ...
  2. El sistema crea una promoción basada en el stock acumulado de dicho equipo y notifica al ususario. \\
  3. El usuario ve la promoción, valida la misma y pasa a estar disponible para los vendedores. \\
  \hline
\end{tabular}
...
\begin{tabular}{ | p{14cm} | }
  ...
  Curso Normal\\
  \hline
  1. El usuario ve la promoción, valida la misma y pasa a estar disponible para los vendedores. \\
  \hline
\end{tabular}
...
\begin{tabular}{ | p{14cm} | }
  ...
  Curso Normal\\
  \hline
  1. El sistema envía un informe con los detalles del estado del mercado al usuario y ofrece la posibilidad de crear una promoción en base al mismo. \\
  2. Se extiende con Validando promoción automática de mercado. \\
  \hline
\end{tabular}
